...
const MOVED_SYMBOLS: { [key: string]: string[] } = {
    ...
    '@arkadium/game-core-engine_to_@arkadium/game-core-multiplayer': [
        'Player',
        'Multiplayer',
        'LobbyManagerSettings',
        'LobbyManager',
        'LobbyPlayerIOManagerSettings',
        'LobbyPlayerIOManager',
        'MultiplayerClient',
        'IMultiplayerModelConnectorWatchConfiguration',
        'IMultiplayerModelConnectorClientConfiguration',
        'IMultiplayerModelConnectorServerConfiguration',
        'MultiplayerModelConnectorClient',
        'MultiplayerModelConnectorServer',
        'MultiplayerModelConnector',
    ],
